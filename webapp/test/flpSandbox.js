		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicación SAPUI5",
									"targetURL": "#sapdemoprimersapui5appprueba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdemoprimersapui5appprueba-display": {
								"semanticObject": "sapdemoprimersapui5appprueba",
								"action": "display",
								"description": "Aplicación de prueba SAPUI5",
								"title": "Aplicación SAPUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.demo.primersapui5.appprueba",
									"url": sap.ui.require.toUrl("sap/demo/primersapui5/appprueba")
								}
							}
						}
					}
